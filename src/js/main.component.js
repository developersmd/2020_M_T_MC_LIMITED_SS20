    ...
    function ItxMainComponentCtrl(
        ...
        _this.$onInit = function () {
            ...
            inditex.onReady(function() {
                ...
                if (mdUtils.isWebapp()) {
                    document.querySelector('.dallonses').classList.add('is-webapp')
                } else {
                    document.querySelector('.dallonses').classList.add('is-web')
                }
        ...
        _this.getInfo = function() {
            ...
            _this.image117 = _this.getResizedImage("assets/poster.jpg");
        };
